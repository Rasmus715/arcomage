...
namespace Arcomage.Scripts
{
	...
	public class Table : Control
	{
		...
		/// <summary>
		/// Represents elapsed time value.
		/// </summary>
		private int _elapsed;
		
		/// <summary>
		/// Represents elapsed time string in 00:00 format.
		/// </summary>
		private string _strElapsed = "00:00"; 
		...
		/// <summary>
		/// Signal that represents graveyard animation ended.
		/// </summary>
		[Signal]
		private delegate void GraveyardAnimationEnded(); 

		/// <summary>
		/// Signal that represents table deck animation ended.
		/// </summary>
		[Signal]
		...
		{
			GD.Print();
			Global.Table = this; // Declare global link to the current game table.
			_rng.Randomize();
			_turn = _rng.RandiRange(0, Players.Count); // "Roll the dice", or in other word - randomize which player's first turn.
		...
		/// <summary>
		/// Playtime for leaderboard.
		/// </summary>
		public void OnTimeElapsedTimeout()
		{
			_elapsed += 1;
			var minutes = _elapsed / 60;
			var seconds = _elapsed % 60;
			_strElapsed = $"{minutes}:{seconds}";
		}
	}
}
